...
%   netlist_path    = mssge_paths.netlist_path;
    ...
    clog('Opening system files','trace');
    ...
    fclose(in_fid);
    clog('Closing system files','trace');
    ...
    case {'ROACH','ROACH2'}
      ...
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      clog('Calculating num opb2opb bridges','trace')
      opb2opbs = 0;
      redo = 1;
